...
/* this is to Prompt to be printed */
#define PROMPT_MSG "dali<3 " /* this is Needed to work with signal */

/* this is to Resume from the unused attibute */
#define UNUSED __attribute__((unused))

/* this is to buffer size for each read call in _getline */
#define BUFFER_SIZE 1024

/******THESE ARE FOR FORMATTED STRING FOR HELP BUILT IN **********/
